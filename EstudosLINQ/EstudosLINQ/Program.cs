...
namespace EstudosLINQ {
    class Program {
        ...
        static void Main(string[] args) {
            ...
            Console.WriteLine("AVG PRICE: " + r13);
            ...
            foreach (IGrouping<Category, Product> _ in r16) {
                Console.WriteLine("Category " + _.Key.Name + ": ");
                foreach(Product p in _) {
                    Console.WriteLine(p);  
                }
                Console.WriteLine();
            }
